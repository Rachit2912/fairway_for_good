        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-2xl border border-[#e2ded4] space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Link href="/dashboard/scores" className="text-xs font-semibold text-[#0f4c46] hover:underline">
                Manage Scores →
              </Link>
            </div>
            <p className="text-xs text-[#1a1d20]/70">
          ...
          <div className="bg-white p-6 rounded-2xl border border-[#e2ded4] space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Link href="/dashboard/charity" className="text-xs font-semibold text-[#0f4c46] hover:underline">
                Change Preference →
              </Link>
            </div>
